...
@section('content')
    ...
    <div class="flex flex-wrap items-center justify-end mb-4 gap-3">
        <form action="{{ route('dashboard.capaian.index') }}" method="GET"
            class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <select name="period_id" onchange="this.form.submit()"
                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 shadow-sm min-w-[200px] transition-all duration-300 hover:border-blue-400">
                <option value="">Semua Waktu (Tanpa Periode)</option>
                ...
                <thead class="text-xs text-gray-900 uppercase bg-gray-100 border-b-2 border-gray-300">
                    <tr>
                        ...
                        <th rowspan="3"
                            ...
                            NAMA DESA</th>
                        <th rowspan="3" class="px-3 py-3 border border-gray-300 align-middle">SASARAN<br>USIA PRODUKTIF</th>
                        <th colspan="6" class="px-4 py-2 border border-gray-300 text-center">HASIL CAPAIAN PERDESA</th>
                    ...
                    <tr>
                        <th colspan="2" class="px-4 py-2 border border-gray-300 text-center">USIA PRODUKTIF</th>
                        <th colspan="2" class="px-4 py-2 border border-gray-300 text-center bg-red-50">HIPERTENSI</th>
                        <th colspan="2" class="px-4 py-2 border border-gray-300 text-center bg-yellow-50">DIABETES MELITUS
                        </th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    @if(count($capaianList) > 0)
                        ...
                        <tr class="font-bold bg-gray-100 border-t-2 border-gray-300">
                            ...
                            <td class="px-3 py-3 border border-gray-300 text-gray-900">{{ $sumSasaranUsia }}</td>

                            <td class="px-3 py-3 border border-gray-300">{{ $sumCapaianUsia }}</td>
                            ...
                            <td class="px-2 py-3 border border-gray-300"></td>
                            <td class="px-2 py-3 border border-gray-300"></td>
                        </tr>
                        {{-- Row SASARAN Bawah --}}
                        <tr class="font-bold bg-gray-200">
                            <td colspan="3" class="px-4 py-3 border border-gray-300 text-center">SASARAN</td>
                            <td colspan="2" class="px-4 py-3 border border-gray-300 text-center">{{ $sumSasaranUsia }}</td>
                            <td colspan="2" class="px-4 py-3 border border-gray-300 text-center bg-red-200">{{ $sumSasaranHt }}
                            </td>
                            <td colspan="2" class="px-4 py-3 border border-gray-300 text-center bg-yellow-200">
                                {{ $sumSasaranDm }}</td>
                            <td class="px-2 py-3 border border-gray-300"></td>
                            <td class="px-2 py-3 border border-gray-300"></td>
                        </tr>
